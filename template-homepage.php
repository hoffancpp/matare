...
<?php include "header.php" ?>
        ...
        <div class="input d-flex justify-content-center align-items-center flex-column py-4">
            <form class="inline justify-content-center align-items-center flex-column py-4 my-3 rounded-4 rounded-lg-0" action="/tours">
                ...
                <div class="input-icons d-flex justify-content-center align-items-center flex-column mt-3">
                    ...
                    <input class="input-field rounded-3" type="text" id="datepicker" data-role="calendarpicker"  data-input-format="%d/%m/%y" placeholder="გამგზავრება">
                </div>
                <div class="input-icons d-flex justify-content-center align-items-center flex-column mt-3">
                    <i class="ms-5"><img src="<?php echo get_template_directory_uri(); ?>/input_elements/calendar.png" alt=""></i>
                ...
                <form class="search-container p-3 px-4 rounded-4" action="/tours/" style="background-color: white;">
                    <div class="input-des">
                        ...
                        <div class="input-icons d-flex justify-content-start align-items-center mb-3">
                            ...
                            <input style="width: 350px !important;" type="text" class="form-control" id="formGroupExampleInput" placeholder="გთხოვთ აირჩიოთ ქალაქი" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="input-des">
                        ...
                        <div class="input-icons d-flex justify-content-start align-items-center mb-3">
                            ...
                            <input style="width: 350px !important;" type="text" class="form-control" id="datepicker" placeholder="გთხოვთ აირჩიოთ თარიღი">
                          </div>
                    </div>
                    <div class="input-des">
                    ...
                    <div class="containerair">    
                        <div class="progress progress-striped">
                            <div class="progress-bar">
                              <img class="airplane" style="position: absolute; display: flex;" src="<?php echo get_template_directory_uri();?>/airplane.png" alt="">
                          </div>                       
                        </div> 
                      </div>
          ...
          <div class="search justify-content-end align-items-center" style="width: 300px;">
              <button class="d-flex justify-content-center align-items-center px-3 py-2 rounded-2" onclick="location.href='<?php echo home_url('/tours/'); ?>'">ძიება <img src="<?php echo get_template_directory_uri(); ?>/input_elements/search.png" alt=""></button>
          </div>
        ...
        <?php if( array_key_exists('content', $information_box) && $information_box['content'] ): ?>
            ...
            <div class="cards-sectiondesk flex-column justify-content-center align-items-center px-3">
                <h1><?php echo $information_box['title'];?></h1>
                <div class="all-cardsdesk d-flex justify-content-center">
                    ...
                    <div class="card-rowdesk d-flex justify-content-center align-items-center flex-column rounded-4 mx-3">
                        ...
                        <h4 class="text-center"><?php echo $box['title']; ?></h4>
                        <p class="text-center"><?php echo $box['text'] ;?></p>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <?php if($advertisement_mobile): ?>
        ...
        <div class="photos justify-content-center align-items-center mt-5 flex-column py-4">
            ...
            <div style="width: 300px;" class="d-flex flex-column justify-content-start mt-5">
                <h3 style="color: #fff;" class="text-center"><?php echo $advertisement_mobile['title']; ?></h3>
                <p style="color: #fff;" class="text-center"><?php echo $advertisement_mobile['text']; ?></p>
                <a class="more-btn d-flex justify-content-center align-items-center p-2 mt-4" style="text-decoration: none; color: #fff; width: fit-content;" href="<?php echo $advertisement_mobile['link']; ?>">მეტის ნახვა <img src="<?php echo get_template_directory_uri();?>/small_icons/arrow-right.png" alt=""></a>
            </div>
    ...
    <?php if($advertisment): ?>
        ...
        <div class="desk-ad justify-content-center align-items-center mt-5">
            ...
            <?php endif; ?>
            <img class="d-flex justify-content-center align-items-center mt-4" src="<?php echo $advertisment['image']['sizes']['large'] ?>" alt="">
            <?php if($advertisment['link']): ?>
                </a>
            <?php endif; ?>
        </div>
    ...
    <?php if($we_offer_block): ?>
        ...
        <div class="offer mt-5 px-2 justify-content-center align-items-center p-3">
            ...
            <div class="offer-cards d-flex flex-column px-3">
                <h1><?php echo $we_offer_block['title']; ?></h1>
                <?php foreach($we_offer_block['content_left'] as $offer): ?>
                    <div class="offer-cardex d-flex align-items-center mt-5">
                        ...
                        <div class="offer-cardtext">
                            <h3 class="ms-3"><?php echo $offer['title']; ?></h3>
                            <p class="ms-3" style="width: 250px;"><?php echo $offer['text']; ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="offer-container d-flex judtify-content-center align-items-center">
                <?php foreach($we_offer_block['content_right'] as $offer): ?>
                    <div class="offer-contex d-flex judtify-content-center align-items-center flex-column">
                        ...
                        <h3 class="text-center mt-3"><?php echo $offer['title']; ?></h3>
                        <p class="text-center mt-3 px-2"><?php echo $offer['text']; ?></p>
            ...
            <div id="carouselExample" class="carousel slide ">
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <img src="<?php echo get_template_directory_uri();?>/city-photos/carousel-img2.png" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="<?php echo get_template_directory_uri();?>/city-photos/carousel-img3.png" class="d-block w-100" alt="...">
                  </div>
                </div>
    ...
    <?php if($services_block): ?>
        <div class="services flex-column justify-content-center align-items-center mt-5 py-2">
            <h1><?php echo $services_block['title']; ?></h1>
    ...
    <div class="blog flex-column justify-content-center align-items-center px-xl-3 mt-5">
        <h1>ბლოგი</h1>
        <p class="text-center mt-3" style="width: 500px;">Lorem ipsum dolor sit amet consectetur. Accumsan vitae tincidunt ultrices adipiscing in sed vitae et ac. Duis congue sit quam egestas sagittis blandit neque facilisi. Turpis ligula ultricies ante dictum </p>
        <div class="all-blog d-flex justify-content-center mt-5">
            <div class="left-blog d-flex flex-column">
                ...
                <div class="blog-text">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur. Accumsan vitae tincidunt ultrices adipiscing in sed vitae et ac. Duis congue sit</p>
                </div>
            </div>
            <div class="rb-blog ms-5 d-flex flex-column ">
                <div class="right-blog d-flex">
                    <div class="rb-text">
                        ...
                        <p class="pe-2" style="width: 400px !important;">Lorem ipsum dolor sit amet consectetur. Accumsan vitae tincidunt </p>
                        <p>JUN 5 2006</p>
                    </div>
                    <img style="width: 200px; height: 150px;" src="<?php echo get_template_directory_uri();?>/blog/sm-rectangle.png" alt="">
                </div>
    ...
    <div class="tree-card justify-content-center align-items-start flex-column mt-5">
        <h1 class="mt-5 ms-2" style="width: 900px;"><?php echo $three_box_block['title']; ?></h1>
        <div class="all3card d-flex mt-5 justify-content-center align-items-center">
