...
<div class="footer justify-content-center align-items-center mt-5 p-2 flex-column">
    <div class="top-footer d-flex">
        ...
        <div class="contact-link d-flex flex-column m-2 px-3">
            ...
            <a href="/contact"><img src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-text.png"
                    alt="">მოგვწერეთ</a>
            <a href="tel:+995322121418"> <img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-phone.png" alt="">+995 322 12
                14 18</a>
            <a href="tel:+995322121418"> <img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-phone.png" alt="">+995 558 12
                14 18</a>
            <a href="mailto:MATARETRAVEL@GMAIL.COM"><img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-mail.png"
                    alt="">MATARETRAVEL@GMAIL.COM</a>
        </div>
    </div>
    <div class="bottom-footer d-flex flex-column">
        <div class="f-socmedia d-flex justify-content-center align-items-center">
            <div class="mf d-flex justify-content-center align-items-center">
                <a href="<?php echo get_field('facebook_link', 'options'); ?>"><img class="p-3"
                        src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/facebook.png" alt=""></a>
                <a href="https://wa.me/<?php echo get_field('whatsapp', 'options'); ?>"><img class="p-3"
                        src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/whatsapp.png" alt=""></a>
                <a href="mailto:<?php echo get_field('gmail', 'options'); ?>"><img class="p-3"
                        src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/gmail.png" alt=""></a>
                <a href="<?php echo get_field('app_store', 'options'); ?>"><img class="p-3"
                        src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/appstore.png" alt=""></a>
                <a href="<?php echo get_field('play_store', 'options'); ?>"><img class="p-3"
                        src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/googleplay.png" alt=""></a>
            </div>
            <div class="f-map d-flex justify-content-center align-items-center">
                <img style="width: 100%;" src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/map.png"
                    alt="">
            </div>
        </div>
    </div>
...
<div class="smdes-card flex-column justify-content-center align-items-center mt-5">
    <div class="smdescard-bck d-flex justify-content-center align-items-center flex-column shadow p-3">
        <h1>
            <?php echo $we_offer_block_mobile['title']; ?>
        </h1>
...
<div class="mb-service flex-column justify-content-center align-items-center mt-5 py-4">
    ...
    <?php if (array_key_exists('link', $services_block_mobile)): ?>
        <a class="more-btn d-flex justify-content-center align-items-center p-2 mt-4"
            style="text-decoration: none; color: #fff;" href="<?php echo $services_block_mobile['link']; ?>">მეტის ნახვა
            <img src="<?php echo get_template_directory_uri(); ?>/small_icons/arrow-right.png" alt=""></a>
    <?php endif; ?>
</div>
...
<div class="mb-blog flex-column jusdtify-content-center align-items-center mt-5 py-5">
    ...
    <div class="blogmb-card d-flex jusdtify-content-center align-items-center flex-column mt-5">
        ...
        <div class="blogmb-text d-flex flex-column justify-content-center mt-3">
            ...
            <p style="color: #fff !important;" class="mt-3">Seed round direct mailing non-disclosure agreement graphical
                user interface rockstar.</p>
            <a class="more-btn d-flex justify-content-center align-items-center p-2 mt-3"
                style="text-decoration: none; color: #fff; width: fit-content;" href="#">მეტის ნახვა <img
...
<div class="desk-carousel justify-content-center align-items-center mt-5">
    <div class="desk-carouselbck d-flex flex-column justify-content-center align-items-center shadow py-3 rounded">
        ...
        <div class="car-arrows mt-3">
            <button style="background-color: #fff;" class="me-5"><img
                    src="<?php echo get_template_directory_uri(); ?>/small_icons/carousel-arrleft.png" alt=""></button>
            <img src="<?php echo get_template_directory_uri(); ?>/small_icons/user.png" alt="">
            <button class="ms-5" style="background-color: #fff;"><img
                    src="<?php echo get_template_directory_uri(); ?>/small_icons/carousel-arrright.png" alt=""></button>
        </div>
        <p style="width: 300px;" class="text-center mt-3">მატარეს დახმარებით ვიმოგზაურე ალანიაში,უპრობლემოდ გავფრინდით
            დამხვედრიკომპანიაც იქვე იყო მიგვიყვანა სასტუმრომდე, ასევე უკანა გზაზეც, არანაირი პრობლემა ან გაუგებრობა არ
            ყოფილა არაფერზე, კმაყოფილი ვარ ძალიან 🙌🏼</p>
...
<div class="footer-mob flex-column mt-5">
    ...
    <div class="contact-mobile d-flex flex-column justify-content-center align-items-center mt-4">
        <h2>
            <?php echo wp_get_nav_menu_name('footer-menu-4'); ?>
        </h2>
        <div class="contact-links d-flex flex-column justify-content-center align-items-start mt-4">
            <a class="mt-2 p-2 rounded-3" href="/contact"><img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-text.png" alt="">მოგვწერეთ</a>
            <a class="mt-2 p-2 rounded-3" href="tel:+995322121418"> <img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-phone.png" alt="">+995 322 12
                14 18</a>
            <a class="mt-2 p-2 rounded-3" href="tel:+995322121418"> <img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-phone.png" alt="">+995 558 12
                14 18</a>
            <a class="mt-2 p-2 rounded-3" href="mailto:MATARETRAVEL@GMAIL.COM"><img
                    src="<?php echo get_template_directory_uri(); ?>/footer-contact-img/f-mail.png"
                    alt="">MATARETRAVEL@GMAIL.COM</a>
        </div>
    </div>
    <div class="social-mediamb d-flex justify-content-center align-items-center">
        <a href="<?php echo get_field('facebook_link', 'options'); ?>"><img class="p-2"
                src="<?php echo get_template_directory_uri(); ?>/footer_mobile/facebook.png" alt=""></a>
        <a href="https://wa.me/<?php echo get_field('whatsapp', 'options'); ?>"><img class="p-2"
                src="<?php echo get_template_directory_uri(); ?>/footer_mobile/whatsapp.png" alt=""></a>
        <a href="mailto:<?php echo get_field('gmail', 'options'); ?>"><img class="p-2"
                src="<?php echo get_template_directory_uri(); ?>/footer_mobile/gmail.png" alt=""></a>
        <a href="<?php echo get_field('app_store', 'options'); ?>"><img class="p-2"
                src="<?php echo get_template_directory_uri(); ?>/footer_mobile/appstore.png" alt=""></a>
        <a href="<?php echo get_field('play_store', 'options'); ?>"><img class="p-2"
                src="<?php echo get_template_directory_uri(); ?>/footer_mobile/googleplay.png" alt=""></a>
    </div>
...
<script>
    $(function () {
        $('.search-container li').on('click', function () {
            let val = $(this).text();
            $(this).parent('ul').siblings('input').val(val);
        });
    });
</script>
</body>
