...
<head>
    ...
    // Récupérer les variables de remplacement pour le titre SEO Rank Math
    $variables = get_post_meta($post->ID, 'rank_math_replacements', true);

    // Convertir les variables de remplacement en tableau associatif
...
<body <?php body_class(); ?>>
    ...
    <div class="top-first justify-content-between align-items-center p-1 px-4">
        <p class="m-0">
            <?php echo $header_banner['left_side_text'] ?>
        </p>
        <p class="m-0">
            <?php echo date("H:i"); ?>
        </p>
    ...
    <nav class="px-4 py-2 d-flex justify-content-between align-items-center justify-content-lg-between">
        ...
        <ul class="d-flex justify-content-between align-items-center justify-content-lg-center px-lg-0">
            <li class="menu-button" onclick="showSidebar()"><a class="px-lg-2" href="#"><img src="./menu.png"
                        alt=""></a></li>
            <?php foreach ($header_menu as $menu): ?>
                <?php if (array_key_exists('child_items', (array) $menu)): ?>
                    <li class="hideOnMobile"><a class="px-lg-2" href="#"> <a class="nav-link pe-2" href="#" role="button"
                            ...
                            <ul class="dropdown-menu">
                                <?php foreach ($menu->child_items as $child): ?>
                                    <li><a class="dropdown-item" href="<?php echo $child->url; ?>"><?php echo $child->title; ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </a></li>
                <?php else: ?>
                    <li class="hideOnMobile no-dr"><a class="px-lg-2"
        ...
        <ul class="sidebar">
            ...
            <li><a style="color: #fff;" class="nav-link ps-2 py-2" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
            ...
            <li> <a style="color: #fff;" class="nav-link pe-2 py-2" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <img class="ps-2" src="<?php echo get_template_directory_uri(); ?>/polygon.png" alt="">
                    სერვისები
                </a>
